...
This week, we will discuss data transformations on __tidy__ data. That is, data that is already in a form where:
...
```{r vis-1, echo=FALSE, fig.height=3, fig.width=4, fig.align='center'}
```
...
```{r vis-2, echo=FALSE, fig.height=2.5, fig.width=4, fig.align='center'}
```
