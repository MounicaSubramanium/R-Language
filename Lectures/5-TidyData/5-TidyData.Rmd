...
![Wickham and Grolemund, _R for Data Science_](wrangle.png)

## Introduction to Data Wrangling

Today we will discuss the often-frustrating but necessary steps that come before we can visualize or model data.
...
Next week, we will discuss importing other types of data.
...
R understands typicaly *nix shortcuts.
...
We will also discuss more on importing and tidying non-tabular data next week.

## Tidy data

![Wickham and Grolemund, _R for Data Science_](tidy.png)
...
![Wickham and Grolemund, _R for Data Science_](gather.png)
...
![Wickham and Grolemund, _R for Data Science_](spread.png)
...
![Wickham and Grolemund, _R for Data Science_](separate.png)
...
![Wickham and Grolemund, _R for Data Science_](unite.png)
